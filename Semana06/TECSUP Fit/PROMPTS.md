# PROMPTS.md — TECSUP Fit (Fase 2: mejora con IA)

Rama: `mejora-ia`
Proyecto: App de reserva de clases de gimnasio (Opción B) en Kotlin con Jetpack Compose y Navigation Compose.
...
**Descripción:** Se agregó inicio de sesión y registro de usuarios con validación de nombre, correo, contraseña y confirmación. El nombre del usuario logueado se muestra en Inicio y Perfil.
...
**Descripción:** El usuario debe elegir un solo horario antes de reservar; se validan cupos llenos y reservas duplicadas. Todas las pantallas tienen topBar en su Scaffold.
...
**Descripción:** Los chips y el buscador filtran clases, las reservas se pueden cancelar, Rutinas tiene su lista y el Perfil muestra estadísticas reales, edición de nombre y cierre de sesión.
